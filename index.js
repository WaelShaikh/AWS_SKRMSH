...
connection.connect(function(err) {
    ...
    connection.query('CREATE TABLE IF NOT EXISTS users(id int NOT NULL AUTO_INCREMENT, username varchar(30), PRIMARY KEY(id));', function(error, result, fields) {
        console.log(result);
    });
    //connection.end();
});
...
io.on('connection', function(socket) {
    ...
    socket.on('log', function(username) {
        ...
        //connection.connect(function(err) {
            connection.query(`INSERT INTO main.users (username) VALUES ('${username}')`, function(err, result, fields) {
