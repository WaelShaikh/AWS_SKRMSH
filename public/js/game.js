...
gameScene.preload = function() {
    this.load.image('player', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/white.png');
    this.load.image('bullet', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/black.png');
//	this.load.image('bg', 'assets/Map.png');
	this.load.image('bg', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/2PMap.png');
	this.load.image('green', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/green.png');
    this.load.image('Tiles', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/ExtrudedTiles.png');
//    this.load.image('Tiles', 'assets/Tiles.png');
    this.load.image('ShadowTiles', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/ShadowTiles.png');
//	this.load.tilemapTiledJSON('map', 'assets/Map.json');
	this.load.tilemapTiledJSON('map', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/2PMap.json');
...
titleScene.preload = function() {
	this.load.image('title', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/title.png');
//  this.load.image('bg', 'assets/Map.png');
    this.load.image('bg', 'http://skrmsh-assets.s3-website-us-east-1.amazonaws.com/2PMap.png');
}
